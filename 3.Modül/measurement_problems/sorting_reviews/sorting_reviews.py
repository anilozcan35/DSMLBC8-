...
score_average_rating(100, 1) # FREKANSLARI DEĞERE SOKAMADI


###################################################
# Wilson Lower Bound Score
###################################################
# BİZE İKİLİ İNTERAKSİYON BARINDIRAN ÖLÇME PROBLEMLERİNİ ÇÖZMEMİZİ SAĞLAR. YÜZDE 95 GÜVEN ARALIĞIYLA DAĞILIMIN ÜZERİNDEKİ MİNUMUM DEĞERİ BİZE VERİR.
# BÖYLECE REVİEWLERI SORT EDECEK SKORLARI ELDE EDEBİLİRİZ.

# 600-400
# 0.6
# 0.5 0.7 # GÜVEN ARALIĞIYLA HESAPLANIYOR
# 0.5 # EN ALT LİMİTİ ALINCA GARANTİ AL SKORU REFERANS ALIYORUZ.
...
# YORUMLARI E TİCARET SİTELERİNDE DÜZENLEYEBİLİRİZ.
